...
public class TextLib {
    ...
    public static ArrayList<DataInfo> readDocInfo(String name){
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                double fleschScore = Double.parseDouble(data[90]);
                double kincaidScore = Double.parseDouble(data[91]);
                DataInfo d = new DataInfo(filename, fleschScore, kincaidScore);
                DataInfoList.add(d);
            }
